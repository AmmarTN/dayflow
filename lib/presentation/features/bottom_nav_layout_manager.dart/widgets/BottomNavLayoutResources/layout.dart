...
class _BottomNavLayoutState extends State<BottomNavLayout> {
  ...
  void initState() {
    ...
    pageStack = widget.pageStack ??
        (Platform.isAndroid ? ReorderToFrontPageStack(initialPage: 0) : NoPageStack(initialPage: 0));
  ...
  void onPageSelected(int index) {
    if (index >= pages.length) {
      throw ArgumentError("There is no page corresponding to the selected navbar item at index $index.");
    }
    // TODO change bail conditions for current project
